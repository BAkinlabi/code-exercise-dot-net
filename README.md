...
The API will start on `http://localhost:7102` by default.
...
docker run -p 7102:7102 urlshortenerapi
...
curl -X POST http://localhost:7102/shorten 
-H "Content-Type: application/json" 
-d '{"fullUrl": "https://mytestwebsite.com/very/long/url"}'

**Response:** 

{ "shortUrl": "http://localhost:7102/abc123" }
...
{ "shortUrl": "http://localhost:7102/my-custom-alias" }

### Redirect to Full URL

**Request:**

curl -v http://localhost:7102/my-custom-alias
...
curl http://localhost:7102/urls

**Response:**

[ { "alias": "my-custom-alias", "fullUrl": "https://mytestwebsite.com/very/long/url", "shortUrl": "http://localhost:7102/my-custom-alias" } ]

### Delete a Shortened URL

**Request:**

curl -X DELETE http://localhost:7102/my-custom-alias
...
- **Port:** The API listens on port `7102` by default.
